...
<div class="space-y-4 p-4 lg:p-6">
	<div class="flex items-center justify-between">
		<h2 class="text-xl font-semibold">Edit Notification Channel</h2>
	...
	<form
		...
		use:enhance={createToastEnhance({
			success: 'Notification channel updated successfully.',
			error: 'Unable to update notification channel.'
		})}
	>
		...
		<div class="space-y-2">
			...
			<Input id="name" name="name" value={data.channel.name} placeholder="Customer Alerts" required />
		</div>
		...
		<div class="space-y-2">
			...
			<Input
				id="apprise_url"
				name="apprise_url"
				value={data.channel.apprise_url}
				placeholder="mailto://user:pass@example.com"
				required
			/>
