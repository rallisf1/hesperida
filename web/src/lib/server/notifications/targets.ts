...
export const parseNotificationTargets = (value: unknown): NotificationTarget[] => {
	...
	for (const entry of value) {
		...
		const createdAt = obj.created_at instanceof DateTime ? obj.created_at : new DateTime();
		const updatedAt = obj.updated_at instanceof DateTime ? obj.updated_at : new DateTime();
