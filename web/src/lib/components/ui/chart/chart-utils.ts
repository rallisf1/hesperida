import type { TooltipContextValue } from "layerchart";
...
export type TooltipPayload = TooltipContextValue["payload"][number];
...
export function getPayloadConfigFromPayload(
	...
	if (payload.key === key) {
		...
		configLabelKey = (data as Record<string, string>)[key];
	}
